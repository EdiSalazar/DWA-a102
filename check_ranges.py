...
param_rages = {
    ...
    'WKmax_permeable_surface': [0.1, 0.2, 'Difference (WKmax - WP)'],
    ...
    'WKmax_paver_stonegrid': [0.1, 0.2, 'Difference (WKmax - WP)'],
    ...
    'a_1_rainwater_usage': [0.0, 1.0, 'Proportion of area 1 (a_1)', ''],
    'a_2_rainwater_usage': [0.0, 1.0, 'Proportion of area 2 (a_2)', ''],
    'a_3_rainwater_usage': [0.0, 1.0, 'Proportion of area 3 (a_3)', ''],
    'a_4_rainwater_usage': [0.0, 1.0, 'Proportion of area 4 (a_4)', ''],
    }
